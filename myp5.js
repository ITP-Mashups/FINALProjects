...
var searchResults1, searchResults2;
...
function loadLyricsOnce() {
  for (var i=0; i< lyrics.length; i++){
      lyricObjects[i]= new Lyric(random(width),random(height), lyrics[i]);
  }
...
Lyric.prototype.render = function() {
  ...
  text(this.text, this.position.x, this.position.y, 90, 76 );
};
